...
const useDarkMode = () => {
    ...
    useEffect(() => {
        if (localStorage.getItem("theme")) setUserTheme(localStorage.getItem("theme") as IPreferColorScheme)
    }, []);
    ...
    useEffect(() => {
        if (typeof window !== "undefined" && window.matchMedia("(prefers-color-scheme: dark)").matches) {
            setSystemTheme(true);
            setUserTheme(localStorage.getItem("theme") as IPreferColorScheme || "dark");
        }
    }, []);
